...
public class DonHang_User_Activity extends AppCompatActivity {
    ...
    private void setupListeners() {
        ...
        btndonhang.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), DonHang_User_Activity.class)));
    ...
    private void loadDonHang(String tenKh) {
        apiManager.getDonHangByCustomer(tenKh, new Callback<List<DonHang>>() {
            @Override
            public void onResponse(Call<List<DonHang>> call, Response<List<DonHang>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(DonHang_User_Activity.this, "Không thể tải đơn hàng", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<DonHang>> call, Throwable t) {
                Toast.makeText(DonHang_User_Activity.this, "Lỗi kết nối: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
