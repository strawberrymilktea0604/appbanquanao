...
public class ThemSanPham_Activity extends AppCompatActivity {
    ...
    private void addSanPham() {
        ...
        String maso = mangNSPList.get(mansp.getSelectedItemPosition()).getMaso(); // Lấy maso từ Spinner
        ...
        // Thêm sản phẩm vào cơ sở dữ liệu - tạm thời disable vì cần chuyển sang API
        Toast.makeText(ThemSanPham_Activity.this, "Chức năng thêm sản phẩm đang được phát triển với API!", Toast.LENGTH_LONG).show();
        
        // Chuyển đến Activity thứ hai
        Intent intentResult = new Intent(getApplicationContext(), Sanpham_admin_Activity.class);
